...
export DATADIR=../New_Data_GLT_2018-2021


# Site coordinates, and bracketing MERRA-2 grid coordinates
export SITE_LAT=76.53
export SITE_LONG=-68.68

export MERRA_LAT0=76.5
export MERRA_LAT1=77
export MERRA_LONG0=-68.75
export MERRA_LONG1=-68.125
...
export PTRUNC=940. # truncation point [mbar] of MERRA-2 profiles
# default site surface pressure [mbar]
export PSURF=940.
# seasonal values override default if set
export PSURF_annual=940.
export PSURF_DJF=939.
export PSURF_MAM=940.
export PSURF_JJA=941.
export PSURF_SON=940.5


export PSURF_Dec=939.
export PSURF_Jan=939.
export PSURF_Feb=939.

export PSURF_Mar=940.
export PSURF_Apr=940.
export PSURF_May=940.

export PSURF_Jun=941.
export PSURF_Jul=941.
export PSURF_Aug=941.

export PSURF_Sep=940.5
export PSURF_Oct=940.5
export PSURF_Nov=940
