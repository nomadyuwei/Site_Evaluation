...
export DATADIR=../New_Data_SMT_2018-2021


# Site coordinates, and bracketing MERRA-2 grid coordinates
export SITE_LAT=32.7
export SITE_LONG=-109.88

export MERRA_LAT0=32.5
export MERRA_LAT1=33
export MERRA_LONG0=-110
export MERRA_LONG1=-109.375
...
export PTRUNC=700. # truncation point [mbar] of MERRA-2 profiles
# default site surface pressure [mbar]
export PSURF=700.
# seasonal values override default if set
export PSURF_annual=700.
export PSURF_DJF=699.
export PSURF_MAM=700.
export PSURF_JJA=701.
export PSURF_SON=700.5


export PSURF_Dec=699.
export PSURF_Jan=699.
export PSURF_Feb=699.

export PSURF_Mar=700.
export PSURF_Apr=700.
export PSURF_May=700.

export PSURF_Jun=701.
export PSURF_Jul=701.
export PSURF_Aug=701.

export PSURF_Sep=700.5
export PSURF_Oct=700.5
export PSURF_Nov=700
